/*
 Navicat Premium Dump SQL - MySQL 5.7 Compatible Version

 Source Server         : mysql
 Source Server Type    : MySQL
 Source Server Version : 90100 (9.1.0) - Converted to MySQL 5.7
 Source Host           : localhost:3306
 Source Schema         : grabTeacher

 Target Server Type    : MySQL
 Target Server Version : 50700 (5.7.0)
 File Encoding         : 65001

 Date: 26/07/2025 20:35:49

 Converted from MySQL 9.1.0 to MySQL 5.7 compatible format
 Main changes:
 - Changed bigint to bigint(20) for MySQL 5.7 compatibility
 - Changed int to int(11) for MySQL 5.7 compatibility
 - Changed collation from utf8mb4_0900_ai_ci to utf8mb4_unicode_ci
 - Ensured all syntax is compatible with MySQL 5.7
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员详细信息表，存储管理员的职务信息和权限';
...
CREATE TABLE `booking_requests` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='预约申请表，记录学生的课程预约申请';
...
CREATE TABLE `reschedule_requests` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='调课申请表，记录课程时间调整申请';
...
CREATE TABLE `schedules` (
  ...
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `recurring_weekdays` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '周期性预约的星期几，逗号分隔：1,3,5',
  `recurring_time_slots` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '周期性预约的时间段，逗号分隔：14:00-16:00,18:00-20:00',
  `is_trial` tinyint(1) DEFAULT '0' COMMENT '是否为试听课：true-是，false-否',
  `session_number` int(11) DEFAULT NULL COMMENT '课程序号（在周期性课程中的第几次课）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='课程安排表，记录具体的上课时间';
...
CREATE TABLE `students` (
  ...
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `gender` enum('男','女','不愿透露') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '不愿透露' COMMENT '性别：男、女、不愿透露',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='学生详细信息表，存储学生的个人资料和学习偏好';
...
CREATE TABLE `subjects` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='科目分类表，定义平台支持的所有教学科目';
...
CREATE TABLE `teachers` (
  ...
  `available_time_slots` text DEFAULT NULL COMMENT '可上课时间安排，JSON格式存储：[{"weekday":1,"timeSlots":["08:00-09:00","10:00-11:00"]},{"weekday":2,"timeSlots":["14:00-15:00"]}]，weekday: 1=周一,2=周二...7=周日',
  `is_verified` tinyint(1) DEFAULT '0' COMMENT '是否已认证：true-已认证，false-未认证',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='教师详细信息表，存储教师的专业资料和教学信息';
...
CREATE TABLE `users` (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '密码（加密）Bcrypt',
...
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户基础信息表，存储所有用户的通用信息';
