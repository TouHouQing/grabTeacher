/*
 ...
 Source Server Version : 50700 (5.7.0)
...
CREATE TABLE `booking_requests` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='预约申请表，记录学生的课程预约申请';
...
CREATE TABLE `courses` (
  ...
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `grade` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '课程适用年级如[小学一年级,小学二年级]',
  `gender` enum('男','女','不限') DEFAULT '不限' COMMENT '适合性别：男、女、不限',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='课程信息表，存储教师发布的课程详情';
...
-- ----------------------------
-- Records of schedules (部分数据，由于行数限制)
-- ----------------------------
BEGIN;
...
CREATE TABLE `subjects` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='科目分类表，定义平台支持的所有教学科目';
...
CREATE TABLE `teachers` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='教师详细信息表，存储教师的专业资料和教学信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户基础信息表，存储所有用户的通用信息';
