...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDTO<Map<String, String>>> handleValidationExceptions(
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDTO.error(400, "数据验证失败: " + firstError));
    }
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleHttpMessageNotReadableException(
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDTO.error(400, message));
    }

    @ExceptionHandler(MissingServletRequestParameterException.class)
    public ResponseEntity<ApiResponseDTO<Object>> handleMissingServletRequestParameterException(
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleHttpRequestMethodNotSupportedException(
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
                .body(ApiResponseDTO.error(405, message));
    }
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleNoHandlerFoundException(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ApiResponseDTO.error(404, message));
    }
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleBadCredentialsException(BadCredentialsException ex) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponseDTO.error(401, "邮箱或密码错误"));
    }
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleAuthenticationException(AuthenticationException ex) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponseDTO.error(401, "认证失败"));
    }
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleIllegalArgumentException(IllegalArgumentException ex) {
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDTO.error(400, "参数错误: " + ex.getMessage()));
    }
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleGeneralException(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponseDTO.error(500, "服务器内部错误，请稍后重试"));
    }
} 