...
class CourseCacheKeyGenerator implements KeyGenerator {
    ...
    public Object generate(Object target, Method method, Object... params) {
        ...
        switch (methodName) {
            case "getCourseList":
                return generateCourseListKey(params);
            case "getTeacherCourses":
                return generateTeacherCoursesKey(params);
            case "getCourseById":
                return generateCourseByIdKey(params);
            case "getActiveCourses":
                return "activeCourses:all";
            default:
                return new CustomCacheKeyGenerator().generate(target, method, params);
        }
    }
