...
CREATE TABLE `admins` (
  ...
  `real_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '管理员真实姓名',
  `wechat_qrcode_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '微信二维码图片URL',
  `whatsapp_number` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'WhatsApp号码',
  ...
  `notes` text COLLATE utf8mb4_general_ci COMMENT '管理员备注信息',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='学生余额变动记录表';

-- ----------------------------
-- Records of balance_transactions
-- ----------------------------
BEGIN;
INSERT INTO `balance_transactions` (`id`, `user_id`, `name`, `amount`, `balance_before`, `balance_after`, `transaction_type`, `reason`, `booking_id`, `operator_id`, `created_at`) VALUES (1, 10, 'student23', 500.00, 0.00, 500.00, 'RECHARGE', '账户充值', NULL, 11, '2025-09-10 10:00:00');
INSERT INTO `balance_transactions` (`id`, `user_id`, `name`, `amount`, `balance_before`, `balance_after`, `transaction_type`, `reason`, `booking_id`, `operator_id`, `created_at`) VALUES (2, 10, 'student23', -120.00, 500.00, 380.00, 'DEDUCT', '预约课程扣费', 13, 11, '2025-09-10 12:00:00');
COMMIT;
...
CREATE TABLE `booking_requests` (
  ...
  `booking_type` enum('single','recurring') COLLATE utf8mb4_general_ci NOT NULL COMMENT '预约类型：single-单次，recurring-周期性',
  ...
  `recurring_weekdays` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '周期性预约的星期几，逗号分隔：1,3,5',
  `recurring_time_slots` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '周期性预约的时间段，逗号分隔：14:00-16:00,18:00-20:00',
  ...
  `student_requirements` text COLLATE utf8mb4_general_ci COMMENT '学生需求说明',
  `status` enum('pending','approved','rejected','cancelled') COLLATE utf8mb4_general_ci DEFAULT 'pending' COMMENT '申请状态pending-待定中，approved-已批准，rejected-已拒绝，cancelled-已取消',
  `teacher_reply` text COLLATE utf8mb4_general_ci COMMENT '教师回复内容',
  `admin_notes` text COLLATE utf8mb4_general_ci COMMENT '管理员备注',
  ...
  `teaching_location` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '线上' COMMENT '授课地点名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='预约申请表，记录学生的课程预约申请';
...
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`, `requested_start_time`, `requested_end_time`, `recurring_weekdays`, `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`, `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`, `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`, `teaching_location_id`, `teaching_location`) VALUES (7, 6, 20, NULL, 'single', '2025-08-08', '10:30:00', '11:00:00', NULL, NULL, NULL, NULL, NULL, '希望预约门捷列夫老师的《初中化学基础课程》课程', 'pending', NULL, NULL, '2025-07-26 18:41:46', '2025-07-26 18:41:46', NULL, 1, '2025-07-28 15:12:55', 1, 30, NULL, '线上');
...
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`, `requested_start_time`, `requested_end_time`, `recurring_weekdays`, `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`, `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`, `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`, `teaching_location_id`, `teaching_location`) VALUES (10, 6, 10, 19, 'recurring', NULL, NULL, NULL, '3', '09:00-10:00', '2025-07-29', '2025-10-14', 12, '希望预约Johnson老师的《小学英语精品课程》课程', 'rejected', NULL, '测试', '2025-07-28 21:09:03', '2025-07-28 21:09:23', NULL, 0, NULL, 0, NULL, NULL, '线上');
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`, `requested_start_time`, `requested_end_time`, `recurring_weekdays`, `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`, `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`, `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`, `teaching_location_id`, `teaching_location`) VALUES (12, 6, 22, NULL, 'single', '2025-09-30', '08:30:00', '09:00:00', NULL, NULL, NULL, NULL, NULL, '申请与林教授老师进行华文科目试听', 'approved', NULL, NULL, '2025-09-10 16:38:56', '2025-09-10 16:38:56', '2025-09-10 16:38:56', 0, NULL, 1, 30, NULL, '线上');
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`, `requested_start_time`, `requested_end_time`, `recurring_weekdays`, `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`, `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`, `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`, `teaching_location_id`, `teaching_location`) VALUES (13, 6, 22, 43, 'recurring', NULL, NULL, NULL, '4', '10:00-12:00', '2025-09-11', '2025-11-27', 12, '希望预约林教授老师的《中学古代文学班》课程', 'approved', NULL, '12332312312', '2025-09-10 21:07:59', '2025-09-10 21:08:11', '2025-09-10 21:08:11', 0, NULL, 0, NULL, 184, '南宁市');
COMMIT;
...
CREATE TABLE `course_enrollments` (
  ...
  `enrollment_type` enum('one_on_one','large_class') COLLATE utf8mb4_general_ci NOT NULL COMMENT '报名类型：one_on_one-一对一,large_class-大班课',
  `total_sessions` int DEFAULT NULL COMMENT '总课程次数',
  `completed_sessions` int DEFAULT '0' COMMENT '已完成课程次数',
  `enrollment_status` enum('active','completed','cancelled','suspended') COLLATE utf8mb4_general_ci DEFAULT 'active' COMMENT '报名状态：active-进行中，completed-已完成，cancelled-已取消，suspended-暂停',
  ...
  `teacher_notes` text COLLATE utf8mb4_general_ci COMMENT '教师备注',
  `student_feedback` text COLLATE utf8mb4_general_ci COMMENT '学生反馈',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='课程关系表，记录学生课程报名关系';

-- ----------------------------
-- Records of course_enrollments
-- ----------------------------
BEGIN;
INSERT INTO `course_enrollments` (`id`, `student_id`, `teacher_id`, `course_id`, `grade`, `enrollment_type`, `total_sessions`, `completed_sessions`, `enrollment_status`, `enrollment_date`, `start_date`, `end_date`, `is_trial`, `recurring_schedule`, `duration_minutes`, `booking_request_id`, `teacher_notes`, `student_feedback`, `created_at`, `is_deleted`, `deleted_at`, `teaching_location_id`, `teaching_location`) VALUES (1, 6, 7, NULL, NULL, 'one_on_one', 12, 0, 'suspended', '2025-07-21', '2025-07-22', '2025-08-26', 0, '{\"weekdays\": [2, 3], \"timeSlots\": [\"17:00-18:00\"]}', 120, 3, NULL, NULL, '2025-07-21 13:12:05', 0, NULL, 0, '线上');
INSERT INTO `course_enrollments` (`id`, `student_id`, `teacher_id`, `course_id`, `grade`, `enrollment_type`, `total_sessions`, `completed_sessions`, `enrollment_status`, `enrollment_date`, `start_date`, `end_date`, `is_trial`, `recurring_schedule`, `duration_minutes`, `booking_request_id`, `teacher_notes`, `student_feedback`, `created_at`, `is_deleted`, `deleted_at`, `teaching_location_id`, `teaching_location`) VALUES (2, 6, 7, 13, NULL, 'large_class', 12, 0, 'active', '2025-07-21', '2025-07-25', '2025-09-02', 0, '{\"weekdays\": [2, 5], \"timeSlots\": [\"14:00-15:00\"]}', 120, 4, NULL, NULL, '2025-07-21 13:47:58', 0, NULL, 0, '线上');
INSERT INTO `course_enrollments` (`id`, `student_id`, `teacher_id`, `course_id`, `grade`, `enrollment_type`, `total_sessions`, `completed_sessions`, `enrollment_status`, `enrollment_date`, `start_date`, `end_date`, `is_trial`, `recurring_schedule`, `duration_minutes`, `booking_request_id`, `teacher_notes`, `student_feedback`, `created_at`, `is_deleted`, `deleted_at`, `teaching_location_id`, `teaching_location`) VALUES (3, 6, 7, 13, NULL, 'large_class', 12, 0, 'suspended', '2025-07-24', '2025-07-25', '2025-10-13', 0, '{\"weekdays\": [1], \"timeSlots\": [\"15:00-16:00\"]}', 120, 9, NULL, NULL, '2025-07-28 16:14:46', 0, NULL, 0, '线上');
INSERT INTO `course_enrollments` (`id`, `student_id`, `teacher_id`, `course_id`, `grade`, `enrollment_type`, `total_sessions`, `completed_sessions`, `enrollment_status`, `enrollment_date`, `start_date`, `end_date`, `is_trial`, `recurring_schedule`, `duration_minutes`, `booking_request_id`, `teacher_notes`, `student_feedback`, `created_at`, `is_deleted`, `deleted_at`, `teaching_location_id`, `teaching_location`) VALUES (4, 6, 22, NULL, NULL, 'one_on_one', 1, 0, 'active', '2025-09-10', '2025-09-30', '2025-09-30', 1, NULL, 120, 12, NULL, NULL, '2025-09-10 16:38:56', 0, NULL, NULL, '线上');
INSERT INTO `course_enrollments` (`id`, `student_id`, `teacher_id`, `course_id`, `grade`, `enrollment_type`, `total_sessions`, `completed_sessions`, `enrollment_status`, `enrollment_date`, `start_date`, `end_date`, `is_trial`, `recurring_schedule`, `duration_minutes`, `booking_request_id`, `teacher_notes`, `student_feedback`, `created_at`, `is_deleted`, `deleted_at`, `teaching_location_id`, `teaching_location`) VALUES (5, 6, 22, 43, NULL, 'large_class', 12, 0, 'active', '2025-09-10', '2025-09-11', '2025-11-27', 0, '{\"weekdays\": [4], \"timeSlots\": [\"10:00-12:00\"]}', 120, 13, NULL, NULL, '2025-09-10 21:08:11', 0, NULL, 184, '南宁市');
COMMIT;
...
CREATE TABLE `course_evaluation` (
  ...
  `teacher_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '教师姓名',
  `student_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '学生姓名',
  ...
  `student_comment` text COLLATE utf8mb4_general_ci COMMENT '学生对课程的评价和建议',
  `rating` decimal(10,7) DEFAULT '5.0000000' COMMENT '课程评分，0-5分',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：0-未删除，1-已删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `course_location` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '课程地点',
  PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `course_evaluation` (`id`, `teacher_id`, `student_id`, `course_id`, `teacher_name`, `student_name`, `course_name`, `is_featured`, `student_comment`, `rating`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`, `course_location`) VALUES (1, 7, 6, 13, '林雅文', 'student23', '小学华文基础班', 1, '老师教学很认真，课程内容很实用，孩子进步很大！', 5.0000000, '2025-08-27 00:39:56', '2025-08-27 00:39:56', 0, NULL, NULL);
INSERT INTO `course_evaluation` (`id`, `teacher_id`, `student_id`, `course_id`, `teacher_name`, `student_name`, `course_name`, `is_featured`, `student_comment`, `rating`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`, `course_location`) VALUES (2, 7, 6, 14, '林雅文', 'student23', '拼音识字启蒙班', 1, '老师很有耐心，教学方法很好，孩子很喜欢！', 5.0000000, '2025-08-27 00:40:27', '2025-08-27 00:40:27', 0, NULL, NULL);
COMMIT;
...
CREATE TABLE `course_schedules` (
  ...
  `schedule_status` enum('scheduled','completed','cancelled','rescheduled') COLLATE utf8mb4_general_ci DEFAULT 'scheduled' COMMENT '安排状态：scheduled-已安排，completed-已完成，cancelled-已取消，rescheduled-已调课',
  `teacher_notes` text COLLATE utf8mb4_general_ci COMMENT '教师课后备注',
  `student_feedback` text COLLATE utf8mb4_general_ci COMMENT '学生课后反馈',
  `reschedule_reason` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '调课原因',
...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='课程安排表，记录具体的上课时间安排';

-- ----------------------------
-- Records of course_schedules
-- ----------------------------
BEGIN;
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (1, 1, '2025-07-22', '17:00:00', '18:00:00', 1, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (2, 1, '2025-07-23', '17:00:00', '18:00:00', 2, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (3, 1, '2025-07-29', '17:00:00', '18:00:00', 3, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (4, 1, '2025-07-30', '17:00:00', '18:00:00', 4, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (5, 1, '2025-08-05', '17:00:00', '18:00:00', 5, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (6, 1, '2025-08-06', '17:00:00', '18:00:00', 6, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (7, 1, '2025-08-12', '17:00:00', '18:00:00', 7, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (8, 1, '2025-08-13', '17:00:00', '18:00:00', 8, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (9, 1, '2025-08-19', '17:00:00', '18:00:00', 9, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (10, 1, '2025-08-20', '17:00:00', '18:00:00', 10, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (11, 1, '2025-08-26', '17:00:00', '18:00:00', 11, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:12:05', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (12, 2, '2025-07-25', '14:00:00', '15:00:00', 1, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (13, 2, '2025-07-29', '14:00:00', '15:00:00', 2, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (14, 2, '2025-08-01', '14:00:00', '15:00:00', 3, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (15, 2, '2025-08-05', '14:00:00', '15:00:00', 4, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (16, 2, '2025-08-08', '14:00:00', '15:00:00', 5, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (17, 2, '2025-08-12', '14:00:00', '15:00:00', 6, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (18, 2, '2025-08-15', '14:00:00', '15:00:00', 7, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (19, 2, '2025-08-19', '14:00:00', '15:00:00', 8, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (20, 2, '2025-08-22', '14:00:00', '15:00:00', 9, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (21, 2, '2025-08-26', '14:00:00', '15:00:00', 10, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (22, 2, '2025-08-29', '14:00:00', '15:00:00', 11, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (23, 2, '2025-09-02', '14:00:00', '15:00:00', 12, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-21 13:47:58', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (24, 3, '2025-07-25', '15:00:00', '16:00:00', 1, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (25, 3, '2025-08-01', '15:00:00', '16:00:00', 2, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (26, 3, '2025-08-08', '15:00:00', '16:00:00', 3, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (27, 3, '2025-08-15', '15:00:00', '16:00:00', 4, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (28, 3, '2025-08-22', '15:00:00', '16:00:00', 5, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (29, 3, '2025-08-29', '15:00:00', '16:00:00', 6, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (30, 3, '2025-09-05', '15:00:00', '16:00:00', 7, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (31, 3, '2025-09-12', '15:00:00', '16:00:00', 8, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (32, 3, '2025-10-13', '15:00:00', '16:00:00', 11, 'scheduled', NULL, NULL, NULL, NULL, '2025-07-28 16:14:46', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (33, 4, '2025-09-30', '08:30:00', '09:00:00', 1, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 16:38:56', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (34, 5, '2025-09-11', '10:00:00', '12:00:00', 1, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (35, 5, '2025-09-18', '10:00:00', '12:00:00', 2, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (36, 5, '2025-09-25', '10:00:00', '12:00:00', 3, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (37, 5, '2025-10-02', '10:00:00', '12:00:00', 4, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (38, 5, '2025-10-09', '10:00:00', '12:00:00', 5, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (39, 5, '2025-10-16', '10:00:00', '12:00:00', 6, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (40, 5, '2025-10-23', '10:00:00', '12:00:00', 7, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (41, 5, '2025-10-30', '10:00:00', '12:00:00', 8, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (42, 5, '2025-11-06', '10:00:00', '12:00:00', 9, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (43, 5, '2025-11-13', '10:00:00', '12:00:00', 10, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (44, 5, '2025-11-20', '10:00:00', '12:00:00', 11, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
INSERT INTO `course_schedules` (`id`, `enrollment_id`, `scheduled_date`, `start_time`, `end_time`, `session_number`, `schedule_status`, `teacher_notes`, `student_feedback`, `reschedule_reason`, `reschedule_request_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES (45, 5, '2025-11-27', '10:00:00', '12:00:00', 12, 'scheduled', NULL, NULL, NULL, NULL, '2025-09-10 21:08:11', 0, NULL);
COMMIT;
...
CREATE TABLE `courses` (
  ...
  `course_time_slots` text COLLATE utf8mb4_general_ci COMMENT '上课时间安排（只有大班课才需要设置上课时间安排），JSON格式存储：[{"weekday":1,"timeSlots":["08:00-10:00","17:00-19:00"]},{"weekday":6,"timeSlots":["13:00-15:00","15:00-17:00"]}]，weekday: 1=周一,2=周二...7=周日',
  `image_url` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '课程封面图URL',
  `duration_minutes` int NOT NULL DEFAULT '120' COMMENT '单次课程时长，单位：分钟，只能选择90分钟或120分钟',
  `status` enum('active','inactive','full','pending') COLLATE utf8mb4_general_ci DEFAULT 'active' COMMENT '课程状态：active-可报名，inactive-已下架，full-已满员，pending-待审批',
  ...
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `course_location` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '线上' COMMENT '课程地点',
  `supports_online` tinyint(1) DEFAULT '0' COMMENT '是否支持线上',
  `offline_locations` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '线下地点ID CSV',
  PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (1, 1, 1, '小学数学基础班', '小学数学基础知识教学，包括四则运算、几何图形等基础概念。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 1, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (2, 1, 1, '小学奥数启蒙班', '小学奥数启蒙课程，培养数学思维和解题技巧。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 1, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (3, 2, 1, '小学应用题专项班', '专门针对小学应用题的解题方法和技巧训练。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 1, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (4, 2, 1, '小学计算能力提升班', '提升小学生的计算速度和准确性。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 1, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (5, 3, 1, '小学几何启蒙班', '小学几何基础知识，培养空间想象能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 1, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (6, 3, 1, '数学游戏趣味班', '通过数学游戏让孩子爱上数学学习。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 1, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (7, 4, 2, '小学科学探索班', '通过有趣的科学实验，让小学生了解自然现象。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (8, 4, 2, '自然观察实践班', '户外自然观察，培养学生的观察能力和科学精神。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 90, 'active', 0, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (9, 5, 2, '科学启蒙实验班', '适合小学生的科学启蒙课程，通过动手实验学习科学。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (10, 5, 2, '生活中的科学', '从生活现象中学习科学原理，培养科学思维。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (11, 6, 2, '环境科学启蒙班', '环境保护和生态科学的启蒙教育。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (12, 6, 2, '科学探究方法班', '教授科学探究的基本方法和思维方式。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:36:22', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (13, 7, 6, '小学华文基础班', '小学华文基础教学，包括拼音、汉字、词汇学习。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (14, 7, 6, '拼音识字启蒙班', '专注拼音教学和汉字识字启蒙。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (15, 8, 6, '小学阅读理解班', '提升小学生的阅读理解能力和语言表达。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (16, 8, 6, '写作启蒙班', '小学写作启蒙，从看图写话开始。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (17, 9, 6, '古诗词启蒙班', '小学古诗词学习，感受传统文化魅力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (18, 9, 6, '传统文化班', '通过故事和游戏学习中华传统文化。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (19, 10, 4, 'KET考试冲刺班', '专为KET考试设计的冲刺课程，涵盖听说读写四项技能。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (20, 10, 4, 'KET口语训练班', 'KET考试口语专项训练，提升口语表达能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (21, 11, 4, 'KET语法基础班', 'KET考试语法基础课程，系统学习英语语法。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (22, 11, 4, 'KET阅读理解班', 'KET阅读理解专项训练，提升阅读技巧。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (23, 12, 4, 'KET写作训练班', 'KET写作专项训练，掌握写作技巧和方法。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (24, 12, 4, 'KET听力突破班', 'KET听力专项训练，提升听力理解能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:38:04', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (25, 13, 5, 'PET考试精品班', 'PET考试专项训练，重点突破语法和词汇难点。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (26, 13, 5, 'PET学术写作班', 'PET考试学术写作训练，提升写作水平。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (27, 14, 5, 'PET口语提升班', 'PET口语专项训练，提升口语流利度和准确性。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (28, 14, 5, 'PET商务英语班', 'PET水平的商务英语应用训练。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (29, 15, 5, 'PET英语文学班', 'PET水平的英语文学鉴赏和分析。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (30, 15, 5, 'PET批判性思维班', '通过英语培养批判性思维能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (31, 16, 1, '中学数学竞赛班', '中学数学竞赛训练，培养高级数学思维。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (32, 16, 1, '高等数学预备班', '为学习高等数学打下坚实基础。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (33, 17, 1, '中学函数专题班', '中学数学函数专题深度学习。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (34, 17, 1, '中学几何证明班', '中学几何证明专项训练。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (35, 18, 1, '数学建模班', '中学数学建模训练，培养应用能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (36, 18, 1, '创新数学思维班', '培养创新数学思维和解题能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:40:53', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (37, 19, 7, '中学物理实验班', '中学物理实验课程，培养实验技能和科学思维。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 90, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (38, 19, 7, '科学研究方法班', '教授科学研究的基本方法和实验设计。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (39, 20, 8, '中学化学实验班', '中学化学实验课程，深入理解化学原理。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (40, 20, 8, '有机化学专题班', '有机化学专题学习，掌握有机反应机理。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (41, 21, 2, '中学生物实验班', '中学生物实验课程，探索生命科学奥秘。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (42, 21, 2, '分子生物学班', '分子生物学基础，了解生命的分子机制。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (43, 22, 6, '中学古代文学班', '中学古代文学学习，深入理解经典作品。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, 1, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线下', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (44, 22, 6, '文言文精读班', '文言文精读训练，提升古文理解能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (45, 23, 6, '中学现代文学班', '中学现代文学鉴赏，培养文学素养。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (46, 23, 6, '中学写作指导班', '中学写作技巧指导，提升表达能力。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (47, 24, 6, '语言学基础班', '语言学基础知识，了解语言的科学原理。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (48, 24, 6, '修辞学应用班', '修辞学应用训练，掌握高级语言技巧。', 5.0000000, 'one_on_one', 199.00, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'active', 0, '2025-07-28 21:44:29', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (49, 1, 1, '小学数学思维训练营', '为期8周的小学数学思维训练大班课，培养逻辑思维和解题能力。每周2次课，系统性提升数学素养。', 5.0000000, 'large_class', 299.00, '2025-09-01', '2025-10-26', 25, NULL, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', NULL, 120, 'active', 1, '2025-07-28 22:00:00', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (50, 7, 6, '小学语文阅读写作提升班', '专注提升小学生阅读理解和写作能力的大班课程。通过经典文本阅读和写作练习，全面提升语文素养。', 5.0000000, 'large_class', 399.00, '2025-09-02', '2025-11-25', 30, NULL, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', NULL, 120, 'active', 1, '2025-07-28 22:00:00', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (51, 10, 4, 'KET考试冲刺大班课', '针对KET考试的集中冲刺训练，12周系统复习，模拟考试练习。适合有一定英语基础的学生。', 5.0000000, 'large_class', 599.00, '2025-09-03', '2025-11-26', 20, NULL, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', NULL, 120, 'active', 1, '2025-07-28 22:00:00', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (52, 4, 2, '小学科学实验探索营', '动手实验为主的科学启蒙大班课，每周进行有趣的科学实验，培养科学思维和动手能力。', 5.0000000, 'large_class', 499.00, '2025-09-05', '2025-12-05', NULL, NULL, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', NULL, 120, 'active', 0, '2025-07-28 22:00:00', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (53, 16, 1, '中学数学竞赛训练班', '面向有数学天赋学生的竞赛训练大班课，涵盖代数、几何、数论等竞赛专题。', 5.0000000, 'large_class', 899.00, '2025-09-07', '2025-12-07', 15, NULL, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', NULL, 120, 'active', 1, '2025-07-28 22:00:00', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (54, 13, 5, 'PET英语能力提升班', '系统提升PET水平英语能力的大班课程，注重听说读写全面发展，为PET考试做准备。', 5.0000000, 'large_class', 699.00, '2025-09-09', '2025-12-09', 18, NULL, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', NULL, 120, 'pending', 0, '2025-07-28 22:00:00', 0, NULL, '线上', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `rating`, `course_type`, `price`, `start_date`, `end_date`, `person_limit`, `enrollment_count`, `course_time_slots`, `image_url`, `duration_minutes`, `status`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`, `course_location`, `supports_online`, `offline_locations`) VALUES (55, 19, 7, '中学物理实验精品班', '中学物理实验大班课，通过系统的实验操作，深入理解物理原理，培养实验技能。', 5.0000000, 'large_class', 499.00, '2025-09-10', '2025-12-10', 12, NULL, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', NULL, 120, 'active', 0, '2025-07-28 22:00:00', 0, NULL, '线上', 0, NULL);
COMMIT;
...
CREATE TABLE `grades` (
  ...
  `name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '年级名称',
...
CREATE TABLE `job_posts` (
  ...
  `status` enum('active','expired') COLLATE utf8mb4_general_ci DEFAULT 'active' COMMENT '招聘状态：active-招聘中，expired-已过期',
...
CREATE TABLE `lesson_grades` (
  ...
  `teacher_comment` text COLLATE utf8mb4_general_ci COMMENT '教师对本节课的评价和建议',
...
-- ----------------------------
BEGIN;
INSERT INTO `lesson_grades` (`id`, `schedule_id`, `student_id`, `score`, `teacher_comment`, `graded_at`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`) VALUES (1, 1, 6, 1.00, '1', '2025-09-10 17:04:52', '2025-09-10 17:04:52', '2025-09-10 17:04:52', 0, NULL);
INSERT INTO `lesson_grades` (`id`, `schedule_id`, `student_id`, `score`, `teacher_comment`, `graded_at`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`) VALUES (2, 2, 6, 100.00, '231321213', '2025-09-10 17:22:59', '2025-09-10 17:22:59', '2025-09-10 17:22:59', 0, NULL);
COMMIT;
...
CREATE TABLE `reschedule_requests` (
  ...
  `applicant_type` enum('student','teacher') COLLATE utf8mb4_general_ci NOT NULL COMMENT '申请人类型',
  `request_type` enum('single','recurring','cancel') COLLATE utf8mb4_general_ci NOT NULL COMMENT '申请类型：single-单次调课，recurring-周期性调课，cancel-取消课程',
  ...
  `new_weekly_schedule` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '新的周期性安排，格式：周一,周三 14:00-16:00;周五 18:00-20:00',
  `reason` text COLLATE utf8mb4_general_ci NOT NULL COMMENT '调课原因',
  `urgency_level` enum('low','medium','high') COLLATE utf8mb4_general_ci DEFAULT 'medium' COMMENT '紧急程度',
  `advance_notice_hours` int DEFAULT NULL COMMENT '提前通知小时数',
  `status` enum('pending','approved','rejected','cancelled') COLLATE utf8mb4_general_ci DEFAULT 'pending' COMMENT '申请状态',
  `reviewer_id` bigint DEFAULT NULL COMMENT '审核人ID',
  `reviewer_type` enum('teacher','student','admin') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审核人类型',
  `review_notes` text COLLATE utf8mb4_general_ci COMMENT '审核备注',
...
CREATE TABLE `schedules` (
  ...
  `end_time` time NOT NULL COMMENT '结束时间',
  `total_times` int DEFAULT NULL COMMENT '总课程次数',
  `status` enum('progressing','completed','cancelled') COLLATE utf8mb4_general_ci DEFAULT 'progressing' COMMENT '课程状态：progressing-进行中，confirmed-已确认，cancelled-已取消',
  `teacher_notes` text COLLATE utf8mb4_general_ci COMMENT '教师课后备注和反馈',
  `student_feedback` text COLLATE utf8mb4_general_ci COMMENT '学生课后反馈',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '排课创建时间',
  `booking_request_id` bigint DEFAULT NULL COMMENT '关联预约申请ID',
  `booking_source` enum('request','admin') COLLATE utf8mb4_general_ci DEFAULT 'request' COMMENT '预约来源：request-申请预约，admin-管理员安排',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `recurring_weekdays` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '周期性预约的星期几，逗号分隔：1,3,5',
  `recurring_time_slots` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '周期性预约的时间段，逗号分隔：14:00-16:00,18:00-20:00',
...
CREATE TABLE `student_subjects` (
  ...
  KEY `idx_student_id` (`student_id`),
  KEY `idx_subject_id` (`subject_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='学生感兴趣科目关联表';

-- ----------------------------
-- Records of student_subjects
-- ----------------------------
BEGIN;
INSERT INTO `student_subjects` (`id`, `student_id`, `subject_id`, `created_at`) VALUES (4, 6, 1, '2025-09-10 21:06:44');
INSERT INTO `student_subjects` (`id`, `student_id`, `subject_id`, `created_at`) VALUES (5, 6, 2, '2025-09-10 21:06:44');
INSERT INTO `student_subjects` (`id`, `student_id`, `subject_id`, `created_at`) VALUES (6, 6, 6, '2025-09-10 21:06:44');
COMMIT;
...
CREATE TABLE `students` (
  ...
  `user_id` bigint NOT NULL COMMENT '关联用户表的用户ID',
  `real_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '学生真实姓名',
  `subjects_interested` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '感兴趣的科目列表如：[数学,英语,物理]',
  `learning_goals` text COLLATE utf8mb4_general_ci COMMENT '学习目标和需求描述',
  `preferred_teaching_style` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '偏好的教学风格，如：严格型、温和型、互动型',
  `balance` decimal(10,2) DEFAULT '0.00' COMMENT '学生余额，单位：M豆',
  `budget_range` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '预算范围，如：100-200元/小时',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `gender` enum('男','女','不愿透露') COLLATE utf8mb4_general_ci DEFAULT '不愿透露' COMMENT '性别：男、女、不愿透露',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `students` (`id`, `user_id`, `real_name`, `subjects_interested`, `learning_goals`, `preferred_teaching_style`, `balance`, `budget_range`, `is_deleted`, `deleted_at`, `gender`) VALUES (6, 10, 'student23', '数学,科学,华文', '希望提高数学和科学成绩，加强华文阅读能力', '实践型教学', 380.00, '100-200', 0, NULL, '不愿透露');
COMMIT;
...
CREATE TABLE `subjects` (
  ...
  `name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '科目名称，如：数学、语文、英语',
  `icon_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '科目图标URL地址',
...
CREATE TABLE `suspension_requests` (
  ...
  `student_id` bigint NOT NULL COMMENT '学生ID',
  `teacher_id` bigint NOT NULL COMMENT '教师ID',
  `reason` text COLLATE utf8mb4_general_ci COMMENT '停课原因',
  ...
  `admin_notes` text COLLATE utf8mb4_general_ci COMMENT '管理员审核备注',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '申请时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `reviewed_at` timestamp NULL DEFAULT NULL COMMENT '审核时间',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
...
-- ----------------------------
BEGIN;
INSERT INTO `suspension_requests` (`id`, `enrollment_id`, `student_id`, `teacher_id`, `reason`, `start_date`, `end_date`, `status`, `admin_id`, `admin_notes`, `created_at`, `updated_at`, `reviewed_at`, `is_deleted`, `deleted_at`) VALUES (1, 1, 6, 7, '学生申请停课', '2025-11-05', '2025-12-26', 'approved', 11, '213312123312', '2025-09-10 18:46:05', '2025-09-10 21:06:24', '2025-09-10 21:06:24', 0, NULL);
INSERT INTO `suspension_requests` (`id`, `enrollment_id`, `student_id`, `teacher_id`, `reason`, `start_date`, `end_date`, `status`, `admin_id`, `admin_notes`, `created_at`, `updated_at`, `reviewed_at`, `is_deleted`, `deleted_at`) VALUES (2, 3, 6, 7, '学生申请停课', '2025-09-17', '2025-09-30', 'approved', 11, '331231223', '2025-09-10 22:04:54', '2025-09-10 22:05:23', '2025-09-10 22:05:23', 0, NULL);
COMMIT;
...
CREATE TABLE `teacher_level` (
  ...
  `name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '教师级别名称',
  `is_active` tinyint NOT NULL COMMENT '是否激活：1-是，0-否',
  `sort_order` int NOT NULL COMMENT '排序顺序',
...
CREATE TABLE `teachers` (
  ...
  `user_id` bigint NOT NULL COMMENT '关联用户表的用户ID',
  `real_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '教师真实姓名',
  `education_background` enum('专科及以下','本科','硕士','博士') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '教育背景：专科及以下、本科、硕士、博士',
  `rating` decimal(10,7) DEFAULT '5.0000000' COMMENT '教师评分，0-5分',
  `teaching_experience` int DEFAULT NULL COMMENT '教学经验年数',
  `specialties` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '专业领域如：[高考数学,竞赛辅导,基础提升]',
  `hourly_rate` decimal(10,2) DEFAULT NULL COMMENT '每小时收费标准，单位：元',
  `introduction` text COLLATE utf8mb4_general_ci COMMENT '个人介绍和教学理念',
  `photo_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '个人照片',
  `gender` enum('男','女','不愿透露') COLLATE utf8mb4_general_ci DEFAULT '不愿透露' COMMENT '性别：男、女、不愿透露',
  ...
  `available_time_slots` text COLLATE utf8mb4_general_ci COMMENT '可上课时间安排，JSON格式存储：[{"weekday":1,"timeSlots":["08:00-10:00","17:00-19:00"]},{"weekday":6,"timeSlots":["13:00-15:00","15:00-17:00"]}]，weekday: 1=周一,2=周二...7=周日',
  `level` varchar(50) COLLATE utf8mb4_general_ci DEFAULT '王牌' COMMENT '教育级别：王牌、金牌、银牌、铜牌等',
  `teaching_locations` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '授课地点',
  `supports_online` tinyint(1) DEFAULT '0' COMMENT '是否支持线上',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`),
...
INSERT INTO `teachers` (`id`, `user_id`, `real_name`, `education_background`, `rating`, `teaching_experience`, `specialties`, `hourly_rate`, `introduction`, `photo_url`, `gender`, `is_verified`, `is_featured`, `is_deleted`, `deleted_at`, `current_hours`, `last_hours`, `available_time_slots`, `level`, `teaching_locations`, `supports_online`) VALUES (37, 183, '青', NULL, 5.0000000, NULL, NULL, NULL, NULL, NULL, '男', 0, 0, 0, NULL, 0.00, 0.00, '[{\"weekday\":1,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":2,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":3,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":4,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":5,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":6,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]},{\"weekday\":7,\"timeSlots\":[\"08:00-10:00\",\"10:00-12:00\",\"13:00-15:00\",\"15:00-17:00\",\"17:00-19:00\",\"19:00-21:00\"]}]', '王牌', NULL, 0);
COMMIT;
...
CREATE TABLE `teaching_locations` (
  ...
  `name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '授课地点名称',
  `address` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '授课地点详细地址',
  `is_active` tinyint NOT NULL COMMENT '是否激活：1-是，0-否',
  `sort_order` int NOT NULL COMMENT '排序顺序',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
...
CREATE TABLE `users` (
  ...
  `username` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户名，唯一标识',
  `email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '邮箱地址，用于登录和通知',
  `password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '密码（加密）Bcrypt',
  `phone` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '手机号码',
  `birth_date` varchar(7) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '出生年月，格式：YYYY-MM',
  `avatar_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '头像图片URL地址',
  `user_type` enum('student','teacher','admin') COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户类型：student-学生，teacher-教师，admin-管理员',
  `status` enum('active','inactive','banned') COLLATE utf8mb4_general_ci DEFAULT 'active' COMMENT '账户状态：active-激活，inactive-未激活，banned-封禁',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除：true-已删除，false-未删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `users` (`id`, `username`, `email`, `password`, `phone`, `birth_date`, `avatar_url`, `user_type`, `status`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`, `trial_times`, `adjustment_times`) VALUES (10, 'student', 'qinghaoyang@foxmail.com', '$2a$10$pd68PvpCnLxJEymLxawDz.HUvpXAh56NFRnhaOXhBe4z2sh2no8iW', '', NULL, NULL, 'student', 'active', '2025-07-19 13:21:54', '2025-09-10 21:06:44', 0, NULL, 0, 3);
