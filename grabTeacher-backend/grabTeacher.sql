...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT ='管理员详细信息表，存储管理员的职务信息和权限';

-- ----------------------------
-- Records of admins
-- ----------------------------
BEGIN;
INSERT INTO `admins` (`id`, `user_id`, `real_name`, `notes`, `is_deleted`, `deleted_at`)
VALUES (1, 11, '管理员', '测试', 0, NULL);
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 11
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='预约申请表，记录学生的课程预约申请';

-- ----------------------------
-- Records of booking_requests
-- ----------------------------
BEGIN;
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (3, 6, 7, NULL, 'recurring', NULL, NULL, NULL, '2,3', '17:00-18:00', '2025-07-22', '2025-08-26', 12,
        '希望预约12355老师的语文课程', 'approved', '可以', NULL, '2025-07-21 13:07:49', '2025-07-21 13:12:05',
        '2025-07-21 13:12:05', 0, NULL, 0, NULL);
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (4, 6, 7, 3, 'recurring', NULL, NULL, NULL, '2,5', '14:00-15:00', '2025-07-23', '2025-08-27', 12,
        '希望预约12355老师的《语文》课程', 'approved', '可以', NULL, '2025-07-21 13:47:39', '2025-07-21 13:47:58',
        '2025-07-21 13:47:58', 1, '2025-07-28 15:23:31', 0, NULL);
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (5, 6, 7, 3, 'single', '2025-08-16', '11:00:00', '11:30:00', NULL, NULL, NULL, NULL, NULL,
        '希望预约12355老师的《语文》课程', 'pending', NULL, NULL, '2025-07-21 22:03:14', '2025-07-21 22:03:14', NULL, 1,
        '2025-07-28 15:23:31', 1, 30);
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (6, 6, 7, 3, 'single', '2025-07-30', '10:30:00', '11:00:00', NULL, NULL, NULL, NULL, NULL,
        '希望预约12355老师的《语文》课程', 'pending', NULL, NULL, '2025-07-21 22:03:24', '2025-07-21 22:03:24', NULL, 1,
        '2025-07-28 15:23:31', 1, 30);
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (7, 6, 115, 5001, 'single', '2025-08-08', '10:30:00', '11:00:00', NULL, NULL, NULL, NULL, NULL,
        '希望预约门捷列夫老师的《初中化学基础课程》课程', 'pending', NULL, NULL, '2025-07-26 18:41:46',
        '2025-07-26 18:41:46', NULL, 1, '2025-07-28 15:12:55', 1, 30);
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (8, 6, 7, 1, 'recurring', NULL, NULL, NULL, '2', '18:00-19:00', '2025-07-28', '2025-09-29', 10,
        '希望预约12355老师的《小学语文基础班》课程', 'rejected', NULL, '我不同意', '2025-07-28 15:53:28',
        '2025-07-28 16:12:38', NULL, 0, NULL, 0, NULL);
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (9, 6, 7, 1, 'recurring', NULL, NULL, NULL, '1', '15:00-16:00', '2025-07-30', '2025-10-15', 12,
        '希望预约12355老师的《小学语文基础班》课程', 'approved', NULL, '可以', '2025-07-28 16:13:38',
        '2025-07-28 16:14:46', '2025-07-28 16:14:46', 0, NULL, 0, NULL);
INSERT INTO `booking_requests` (`id`, `student_id`, `teacher_id`, `course_id`, `booking_type`, `requested_date`,
                                `requested_start_time`, `requested_end_time`, `recurring_weekdays`,
                                `recurring_time_slots`, `start_date`, `end_date`, `total_times`, `student_requirements`,
                                `status`, `teacher_reply`, `admin_notes`, `created_at`, `updated_at`, `approved_at`,
                                `is_deleted`, `deleted_at`, `is_trial`, `trial_duration_minutes`)
VALUES (10, 6, 110, 3003, 'recurring', NULL, NULL, NULL, '3', '09:00-10:00', '2025-07-29', '2025-10-14', 12,
        '希望预约Johnson老师的《小学英语精品课程》课程', 'rejected', NULL, '测试', '2025-07-28 21:09:03',
        '2025-07-28 21:09:23', NULL, 0, NULL, 0, NULL);
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 554
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='课程年级关联表';

-- ----------------------------
-- Records of course_grades
-- ----------------------------
BEGIN;
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (506, 1, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (507, 2, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (508, 3, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (509, 4, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (510, 5, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (511, 6, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (512, 7, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (513, 8, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (514, 9, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (515, 10, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (516, 11, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (517, 12, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (518, 13, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (519, 14, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (520, 15, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (521, 16, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (522, 17, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (523, 18, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (524, 19, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (525, 20, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (526, 21, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (527, 22, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (528, 23, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (529, 24, '小学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (530, 25, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (531, 26, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (532, 27, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (533, 28, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (534, 29, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (535, 30, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (536, 31, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (537, 32, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (538, 33, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (539, 34, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (540, 35, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (541, 36, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (542, 37, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (543, 38, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (544, 39, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (545, 40, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (546, 41, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (547, 42, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (548, 43, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (549, 44, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (550, 45, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (551, 46, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (552, 47, '中学', '2025-07-28 21:53:43');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (553, 48, '中学', '2025-07-28 22:00:56');
-- 为新增大班课添加年级关联
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (554, 49, '小学', '2025-07-28 22:00:56');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (555, 50, '小学', '2025-07-28 22:00:56');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (556, 51, '小学', '2025-07-28 22:00:56');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (557, 52, '小学', '2025-07-28 22:00:56');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (558, 53, '中学', '2025-07-28 22:00:56');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (559, 54, '中学', '2025-07-28 22:00:56');
INSERT INTO `course_grades` (`id`, `course_id`, `grade`, `created_at`)
VALUES (560, 55, '中学', '2025-07-28 22:00:56');
COMMIT;
...
(
    ...
    `base_rating`       decimal(3, 2)                                                                                DEFAULT 5 COMMENT '课程基础评分，0-5分',
  ...
  AUTO_INCREMENT = 49
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='课程信息表，存储教师发布的课程详情';
...
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
VALUES (8, 4, 2, '自然观察实践班', '户外自然观察，培养学生的观察能力和科学精神。', 'one_on_one', NULL, NULL, NULL, NULL,
        90, 'active', 0, '2025-07-28 21:36:22', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
...
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
VALUES (13, 7, 3, '小学华文基础班', '小学华文基础教学，包括拼音、汉字、词汇学习。', 'one_on_one', NULL, NULL, NULL, NULL,
        60, 'active', 0, '2025-07-28 21:38:04', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
...
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
VALUES (37, 19, 7, '中学物理实验班', '中学物理实验课程，培养实验技能和科学思维。', 'one_on_one', NULL, NULL, NULL, NULL,
        90, 'active', 0, '2025-07-28 21:44:29', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
...
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
VALUES (50, 7, 3, '小学语文阅读写作提升班',
        '专注提升小学生阅读理解和写作能力的大班课程。通过经典文本阅读和写作练习，全面提升语文素养。', 'large_class',
        399.00, '2025-09-02', '2025-11-25', 30, 120, 'active', 1, '2025-07-28 22:00:00', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
VALUES (51, 10, 4, 'KET考试冲刺大班课', '针对KET考试的集中冲刺训练，12周系统复习，模拟考试练习。适合有一定英语基础的学生。',
        'large_class', 599.00, '2025-09-03', '2025-11-26', 20, 120, 'active', 1, '2025-07-28 22:00:00', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
...
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
VALUES (54, 13, 5, 'PET英语能力提升班', '系统提升PET水平英语能力的大班课程，注重听说读写全面发展，为PET考试做准备。',
        'large_class', 699.00, '2025-09-09', '2025-12-09', 18, 120, 'pending', 0, '2025-07-28 22:00:00', 0, NULL);
INSERT INTO `courses` (`id`, `teacher_id`, `subject_id`, `title`, `description`, `course_type`, `price`, `start_date`,
                       `end_date`, `person_limit`, `duration_minutes`, `status`, `is_featured`, `created_at`,
                       `is_deleted`, `deleted_at`)
VALUES (55, 19, 7, '中学物理实验精品班', '中学物理实验大班课，通过系统的实验操作，深入理解物理原理，培养实验技能。',
        'large_class', NULL, '2025-09-10', '2025-12-10', 12, 120, 'active', 0, '2025-07-28 22:00:00', 0, NULL);
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 16
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='年级信息表，存储系统中的年级数据';

-- ----------------------------
-- Records of grades
-- ----------------------------
BEGIN;
INSERT INTO `grades` (`id`, `grade_name`, `description`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`)
VALUES (14, '小学', '小学阶段，适合6-12岁儿童', '2025-07-28 21:55:14', '2025-07-28 21:55:14', 0, NULL);
INSERT INTO `grades` (`id`, `grade_name`, `description`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`)
VALUES (15, '中学', '中学阶段，适合12-18岁学生', '2025-07-28 21:55:14', '2025-07-28 21:55:14', 0, NULL);
INSERT INTO `grades` (`id`, `grade_name`, `description`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`)
VALUES (16, '高中', '高中阶段，适合15-18岁学生', '2025-07-28 21:55:14', '2025-07-28 21:55:14', 0, NULL);
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='调课申请表，记录课程时间调整申请';
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='学生感兴趣科目关联表';
...
(
  ...
  AUTO_INCREMENT = 8
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='学生详细信息表，存储学生的个人资料和学习偏好';
...
(
  ...
  AUTO_INCREMENT = 9
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='科目分类表，定义平台支持的所有教学科目';

-- ----------------------------
-- Records of subjects
-- ----------------------------
BEGIN;
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (1, '小学数学', '', 1, 0, NULL);
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (2, '小学科学', '', 1, 0, NULL);
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (3, '小学华文', '', 1, 0, NULL);
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (4, '英文(KET)', '', 1, 0, NULL);
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (5, '英文(PET)', '', 1, 0, NULL);
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (6, '中学数学', '', 1, 0, NULL);
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (7, '中学科学', '', 1, 0, NULL);
INSERT INTO `subjects` (`id`, `name`, `icon_url`, `is_active`, `is_deleted`, `deleted_at`)
VALUES (8, '中学华文', '', 1, 0, NULL);
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 25
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='教师科目关联表';
...
VALUES (1, 1, 1, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (2, 2, 1, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (3, 3, 1, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (4, 4, 2, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (5, 5, 2, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (6, 6, 2, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (7, 7, 3, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (8, 8, 3, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (9, 9, 3, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (10, 10, 4, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (11, 11, 4, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (12, 12, 4, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (13, 13, 5, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (14, 14, 5, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (15, 15, 5, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (16, 16, 6, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (17, 17, 6, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (18, 18, 6, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (19, 19, 7, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (20, 20, 7, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (21, 21, 7, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (22, 22, 8, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (23, 23, 8, '2025-07-28 21:36:22');
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `created_at`)
VALUES (24, 24, 8, '2025-07-28 21:36:22');
COMMIT;
...
(
    ...
    `base_rating`          decimal(3, 2)               DEFAULT 5 COMMENT '教师基础评分，0-5分',
    `rating`               decimal(3, 2)               DEFAULT 5 COMMENT '教师评分，0-5分',
  ...
  AUTO_INCREMENT = 38
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='教师详细信息表，存储教师的专业资料和教学信息';
...
(
  ...
  AUTO_INCREMENT = 184
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='用户基础信息表，存储所有用户的通用信息';
...
UPDATE `teachers`
SET `is_featured` = 1
WHERE `id` IN (1, 2, 7, 10, 13, 16, 19, 22);
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='留学国家管理表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='留学阶段管理表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='留学项目管理表';
...
-- 基础国家（若已存在会忽略）
INSERT IGNORE INTO `study_abroad_countries` (`country_name`, `sort_order`, `is_active`)
VALUES ('中国', 0, 1),
       ('美国', 0, 1),
       ('英国', 0, 1),
       ('加拿大', 0, 1);
...
-- 基础阶段（若已存在会忽略）
INSERT IGNORE INTO `study_abroad_stages` (`stage_name`, `sort_order`, `is_active`)
VALUES ('高中', 0, 1),
       ('本科', 0, 1),
       ('硕士', 0, 1);

-- 留学项目示例（依赖上方国家/阶段），避免重复插入
INSERT INTO `study_abroad_programs` (`title`, `country_id`, `stage_id`, `description`, `image_url`, `tags`, `is_hot`,
                                     `sort_order`, `is_active`)
SELECT '英国高中A-Level申请指导',
       c.id,
       s.id,
       'A-Level 选课、文书、面试全流程辅导',
       NULL,
       '["文书指导","面试培训","选课规划"]',
       1,
       10,
       1
FROM study_abroad_countries c,
     study_abroad_stages s
WHERE c.country_name = '英国'
  AND c.is_deleted = 0
  AND s.stage_name = '高中'
  AND s.is_deleted = 0
  AND NOT EXISTS (SELECT 1
                  FROM study_abroad_programs p
                  WHERE p.title = '英国高中A-Level申请指导'
...
INSERT INTO `study_abroad_programs` (`title`, `country_id`, `stage_id`, `description`, `image_url`, `tags`, `is_hot`,
                                     `sort_order`, `is_active`)
SELECT '美国本科通用申请（Common App）',
       c.id,
       s.id,
       'Common App 文书、活动梳理、网申提交',
       NULL,
       '["文书指导","活动背景","网申"]',
       1,
       20,
...
FROM study_abroad_countries c,
     study_abroad_stages s
WHERE c.country_name = '美国'
  AND c.is_deleted = 0
  AND s.stage_name = '本科'
  AND s.is_deleted = 0
  AND NOT EXISTS (SELECT 1
                  FROM study_abroad_programs p
                  WHERE p.title = '美国本科通用申请（Common App）'
                    AND p.country_id = c.id
                    AND p.stage_id = s.id
                    AND p.is_deleted = 0);
...
FROM study_abroad_countries c,
     study_abroad_stages s
WHERE c.country_name = '加拿大'
  AND c.is_deleted = 0
  AND s.stage_name = '硕士'
  AND s.is_deleted = 0
  AND NOT EXISTS (SELECT 1
                  FROM study_abroad_programs p
                  WHERE p.title = '加拿大硕士工科申请'
                    AND p.country_id = c.id
                    AND p.stage_id = s.id
                    AND p.is_deleted = 0);
...
FROM study_abroad_countries c,
     study_abroad_stages s
WHERE c.country_name = '中国'
  AND c.is_deleted = 0
  AND s.stage_name = '本科'
  AND s.is_deleted = 0
  AND NOT EXISTS (SELECT 1
                  FROM study_abroad_programs p
                  WHERE p.title = '中国港澳本科申请'
                    AND p.country_id = c.id
                    AND p.stage_id = s.id
                    AND p.is_deleted = 0);
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='教师招聘信息表，供前台招聘页面展示';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='招聘与年级的多对多关联表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='招聘与科目的多对多关联表';
...
BEGIN;
-- 岗位1：小学数学兼职教师（线上）
INSERT INTO `job_posts` (`id`, `title`, `introduction`, `position_tags`, `grade_ids`, `grade_names`, `subject_ids`,
                         `subject_names`, `status`, `priority`, `created_at`, `is_deleted`)
VALUES (1001, '小学数学兼职教师', '负责小学数学线上授课，要求有耐心，有相关教学经验。', '["兼职","线上"]', '14', '小学',
        '1', '小学数学', 'active', 10, NOW(), 0);
INSERT INTO `job_post_grades` (`job_post_id`, `grade_id`)
VALUES (1001, 14);
INSERT INTO `job_post_subjects` (`job_post_id`, `subject_id`)
VALUES (1001, 1);

-- 岗位2：初中英语教师（可远程）
INSERT INTO `job_posts` (`id`, `title`, `introduction`, `position_tags`, `grade_ids`, `grade_names`, `subject_ids`,
                         `subject_names`, `status`, `priority`, `created_at`, `is_deleted`)
VALUES (1002, '初中英语教师', '负责初中阶段英语课程，小班教学，注重口语与阅读能力提升。', '["全职","远程"]', '15', '中学',
        '4', '英文(KET)', 'active', 20, NOW(), 0);
INSERT INTO `job_post_grades` (`job_post_id`, `grade_id`)
VALUES (1002, 15);
INSERT INTO `job_post_subjects` (`job_post_id`, `subject_id`)
VALUES (1002, 4);
...
INSERT INTO `job_posts` (`id`, `title`, `introduction`, `position_tags`, `grade_ids`, `grade_names`, `subject_ids`,
                         `subject_names`, `status`, `priority`, `created_at`, `is_deleted`)
VALUES (1003, '高中科学精品课主讲', '主讲高中科学精品课程，擅长模型化与解题思维训练；可提供讲义。', '["全职","线下优先"]',
        '16', '高中', '7', '中学科学', 'active', 30, NOW(), 0);
INSERT INTO `job_post_grades` (`job_post_id`, `grade_id`)
VALUES (1003, 16);
INSERT INTO `job_post_subjects` (`job_post_id`, `subject_id`)
VALUES (1003, 7);
...
INSERT INTO `job_posts` (`id`, `title`, `introduction`, `position_tags`, `grade_ids`, `grade_names`, `subject_ids`,
                         `subject_names`, `status`, `priority`, `created_at`, `is_deleted`)
VALUES (1004, '华文阅读写作指导', '教授阅读理解与写作技巧，面向小学和中学段学生；支持晚间时段授课。', '["兼职","晚间"]',
        '14,15', '小学,中学', '3,8', '小学华文,中学华文', 'active', 40, NOW(), 0);
INSERT INTO `job_post_grades` (`job_post_id`, `grade_id`)
VALUES (1004, 14),
       (1004, 15);
INSERT INTO `job_post_subjects` (`job_post_id`, `subject_id`)
...
-- 插入测试数据
INSERT INTO `message` (`title`, `content`, `target_type`, `admin_id`, `admin_name`)
VALUES ('欢迎加入抢老师平台', '欢迎各位同学加入我们的在线教育平台，这里有优质的师资资源等待您的发现！', 'STUDENT', 1,
        '系统管理员'),
       ('平台教师指导手册', '各位老师，感谢您加入我们的平台。请仔细阅读教师指导手册，了解平台的各项功能和操作流程。',
        'TEACHER', 1, '系统管理员'),
       ('平台维护通知',
