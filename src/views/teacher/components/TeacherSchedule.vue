...
const classes = ref<ScheduleClass[]>([
  {
    ...
    duration: 120,
    studentName: '张同学',
    studentAvatar: 'https://img1.baidu.com/it/u=1817951587,699502146&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500',
    subject: '数学',
    location: '线上课堂',
  ...
  },
  {
    ...
    duration: 120,
    studentName: '李同学',
    studentAvatar: 'https://img1.baidu.com/it/u=1871939462,1747704439&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500',
    subject: '物理',
    location: '线上课堂',
    content: '电磁感应现象及应用',
    status: 'upcoming'
  ...
  },
  {
    ...
    duration: 120,
    studentName: '王同学',
    studentAvatar: 'https://img0.baidu.com/it/u=2639242239,945866260&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500',
    subject: '生物',
    location: '线上课堂',
    content: '基因的概念与DNA结构',
    status: 'upcoming'
